...
import { extractPages } from '../../../../lib/pdf-processor.js';
...
export async function POST(request) {
  ...
  try {
    ...
    const result = await extractPages(buf, pages);
    return buildFileResponse(result,'application/pdf','extracted.pdf');
  } catch(err) { return buildErrorResponse(err,'extract-pages'); }
}
