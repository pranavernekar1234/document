...
const OPTIONS = ({ values, setOpt }) => (
    <div>
      <label className="text-black/45 text-xs font-medium block mb-2">Pages to Remove</label>
      ...
      <p className="text-black/35 text-xs mt-1.5">Enter page numbers or ranges, comma-separated</p>
    </div>
  );
