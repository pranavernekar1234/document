...
const OPTIONS = ({ values, setOpt }) => (
    <div className="space-y-4">
      <div>
        <label className="text-slate-400 text-xs font-medium block mb-1.5">Watermark Text</label>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          <label className="text-slate-400 text-xs font-medium block mb-1.5">Opacity (0-1)</label>
        ...
        <div>
          <label className="text-slate-400 text-xs font-medium block mb-1.5">Rotation (°)</label>
